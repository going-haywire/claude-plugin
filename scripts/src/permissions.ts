...
export interface MergeResult {
  /** The settings object to write (or that was already there, unchanged). */
  settings: Record<string, unknown>;
  /** False when the rule was already present — nothing to write. */
  changed: boolean;
}
 ...
 */
export function apply(scope: Scope, projectDir: string): ApplyResult {
